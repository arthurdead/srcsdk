...
enum EngineRenderGroup_t
{
	...
	ENGINE_RENDER_GROUP_OPAQUE_STATIC_HUGE = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_STATIC( RENDER_GROUP_BUCKET_HUGE ),
	ENGINE_RENDER_GROUP_OPAQUE_STATIC_MEDIUM = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_STATIC( RENDER_GROUP_BUCKET_MEDIUM ),
	ENGINE_RENDER_GROUP_OPAQUE_STATIC_SMALL = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_STATIC( RENDER_GROUP_BUCKET_SMALL ),
	ENGINE_RENDER_GROUP_OPAQUE_STATIC_TINY = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_STATIC( RENDER_GROUP_BUCKET_TINY ),

	ENGINE_RENDER_GROUP_OPAQUE_ENTITY_HUGE = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_ENTITY( RENDER_GROUP_BUCKET_HUGE ),
	ENGINE_RENDER_GROUP_OPAQUE_ENTITY_MEDIUM = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_ENTITY( RENDER_GROUP_BUCKET_MEDIUM ),
	ENGINE_RENDER_GROUP_OPAQUE_ENTITY_SMALL = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_ENTITY( RENDER_GROUP_BUCKET_SMALL ),
	ENGINE_RENDER_GROUP_OPAQUE_ENTITY_TINY = ENGINE_RENDER_GROUP_OPAQUE_BUCKETED_ENTITY( RENDER_GROUP_BUCKET_TINY ),
