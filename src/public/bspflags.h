...
enum ContentsFlags_t : unsigned int
{
	...
	// just the world, used for route rebuilding
	MASK_PLAYERWORLDSTATIC = (CONTENTS_SOLID|CONTENTS_WINDOW|CONTENTS_PLAYERCLIP|CONTENTS_GRATE),

	MASK_AI_VISION = (MASK_BLOCKLOS_AND_NPCS|CONTENTS_IGNORE_NODRAW_OPAQUE),
