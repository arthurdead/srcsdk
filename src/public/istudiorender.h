...
enum MaterialVertexFormat_t : uint64
{
	...
	MATERIAL_VERTEX_FORMAT_MODEL				= (VertexFormat_t) VERTEX_POSITION3D | VERTEX_COLOR | VERTEX_NORMAL | VERTEX_TEXCOORD0_2D | VERTEX_USERDATA_SIZE(4),
	MATERIAL_VERTEX_FORMAT_MODEL_DX7			= (VertexFormat_t) VERTEX_POSITION3D | VERTEX_COLOR | VERTEX_NORMAL | VERTEX_TEXCOORD0_2D,
...
struct DrawModelInfo_t
{
	...
	const studiohwdata_t	*m_pHardwareData;
