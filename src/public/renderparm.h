...
enum RenderParamVector_t
{
	...
	VECTOR_RENDERPARM_GLOBAL_LIGHT_DIRECTION,
	...
	VECTOR_RENDERPARM_CASCADED_STEP,
	VECTOR_RENDERPARM_CASCADED_AMBIENT_MIN,
	VECTOR_RENDERPARM_CASCADED_AMBIENT_DELTA,
...
enum RenderParamFloat_t
{
	...
	FLOAT_RENDERPARM_DEST_ALPHA_DEPTH_SCALE,
