...
public:
	...
	CPanelAnimationVarAliasType( vgui::HTexture, m_nNBBgTextureId1, "NBTexture1", "vgui/hud/800corner1", "textureid" );
	CPanelAnimationVarAliasType( vgui::HTexture, m_nNBBgTextureId2, "NBTexture2", "vgui/hud/800corner2", "textureid" );
	CPanelAnimationVarAliasType( vgui::HTexture, m_nNBBgTextureId3, "NBTexture3", "vgui/hud/800corner3", "textureid" );
	CPanelAnimationVarAliasType( vgui::HTexture, m_nNBBgTextureId4, "NBTexture4", "vgui/hud/800corner4", "textureid" );
};
