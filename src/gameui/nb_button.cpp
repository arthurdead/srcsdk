...
{
	if ( m_nNBBgTextureId1 == vgui::INVALID_TEXTURE ||
		m_nNBBgTextureId2 == vgui::INVALID_TEXTURE ||
		m_nNBBgTextureId3 == vgui::INVALID_TEXTURE ||
		m_nNBBgTextureId4 == vgui::INVALID_TEXTURE )
	{
		return;
	}
