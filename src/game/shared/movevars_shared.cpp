...
static ConVar	s_sv_gravity		( "sv_gravity", DEFAULT_GRAVITY_STRING, FCVAR_NOTIFY | FCVAR_REPLICATED, "World gravity." );

float GetCurrentGravity( void )
{
	if ( GameRules() )
	{
		return ( s_sv_gravity.GetFloat() * GameRules()->GetGravityMultiplier() );
	}

	return s_sv_gravity.GetFloat();
}
