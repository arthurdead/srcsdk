...
#ifndef CLIENT_DLL
	ConVar unit_density_eclipse_inside_scale("density_eclipse_inside_scale", "5", FCVAR_REPLICATED, "Change sigma", OnDensityConVarChanged);
	ConVar unit_density_eclipse_sigma_scale("density_eclipse_sigma_scale", "0.3", FCVAR_REPLICATED, "Change sigma", OnDensityConVarChanged);
#else
	ConVar unit_density_eclipse_inside_scale("density_eclipse_inside_scale", "5", FCVAR_REPLICATED, "Change sigma");
	ConVar unit_density_eclipse_sigma_scale("density_eclipse_sigma_scale", "0.3", FCVAR_REPLICATED, "Change sigma");
#endif // CLIENT_DLL
...
// Purpose: 
//-----------------------------------------------------------------------------
void DensityWeightsMap::Init( CSharedBaseEntity *pOuter )
{
	m_pOuter = pOuter;
}
