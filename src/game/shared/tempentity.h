...
#define TE_EXPLFLAG_DLIGHT		0x4	// explosion has a DLIGHT
#define TE_EXPLFLAG_NOSOUND		0x8	// do not play client explosion sound
#define TE_EXPLFLAG_NOPARTICLES	0x10	// do not draw particles
#define TE_EXPLFLAG_DRAWALPHA	0x20	// sprite will be drawn alpha
#define TE_EXPLFLAG_ROTATE		0x40	// rotate the sprite randomly
#define TE_EXPLFLAG_NOFIREBALL	0x80	// do not draw a fireball
#define TE_EXPLFLAG_NOFIREBALLSMOKE	0x100	// do not draw smoke with the fireball
#define TE_EXPLFLAG_ICE			0x200	// do ice effects
#define TE_EXPLFLAG_SCALEPARTICLES		0x400
