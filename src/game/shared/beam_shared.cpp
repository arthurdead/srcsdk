...
BEGIN_PREDICTION_DATA( C_Beam )
	...
	DEFINE_FIELD_FLAGS( m_nBeamType, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	...
	DEFINE_FIELD_FLAGS( m_fFadeLength, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_fAmplitude, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_fStartFrame, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_fSpeed, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),

	//TODO!!!! Arthurdead
	//DEFINE_FIELD_FLAGS( m_nRenderFX, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	//DEFINE_FIELD_FLAGS( m_nRenderMode, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),

	DEFINE_FIELD_FLAGS( m_flFrameRate, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_flFrame, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_nMinDXLevel, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS_TOL( m_vecEndPos, FIELD_VECTOR, FTYPEDESC_INSENDTABLE, 0.125f ),
#ifdef PORTAL
	...
	//DEFINE_FIELD_FLAGS( m_flHDRColorScale, SendProxy_HDRColorScale ),
...
CSharedBaseEntity *CSharedBeam::RandomTargetname( const char *szName )
{
	...
	{
		total++;
		if (random_valve->RandomInt(0,total-1) < 1)
			pEntity = pNewEntity;
	}
	return pEntity;
#else
