...
//
//=============================================================================//
#ifndef PLAYERANIMSTATE_H
#define PLAYERANIMSTATE_H
#pragma once
...
public:
	...
	DECLARE_CLASS_NOBASE( CPlayerAnimState );
...
protected:
	...
	PlayerPoseData_t		m_PoseParameterData;
	...
	PlayerMovementData_t	m_MovementData;
