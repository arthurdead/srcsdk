...
FLAGENUM_OPERATORS( DamageTypes_t, uint64 )
...
public:
	...
	CTakeDamageInfo();
	CTakeDamageInfo( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0 );
	CTakeDamageInfo( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0 );
	CTakeDamageInfo( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, const Vector &damageForce, const Vector &damagePosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0, Vector *reportedPosition = NULL );
	CTakeDamageInfo( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, const Vector &damageForce, const Vector &damagePosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0, Vector *reportedPosition = NULL );
	...
	DamageTypes_t				GetDamageType() const;
	void			SetDamageType( DamageTypes_t bitsDamageType );
	void			AddDamageType( DamageTypes_t bitsDamageType );
	...
	AmmoIndex_t				GetAmmoType() const;
	void			SetAmmoType( AmmoIndex_t iAmmoType );
	...
	void			Set( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0 );
	void			Set( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0 );
	void			Set( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, const Vector &damageForce, const Vector &damagePosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0, Vector *reportedPosition = NULL );
	void			Set( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, const Vector &damageForce, const Vector &damagePosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType = 0, Vector *reportedPosition = NULL );
	...
	static void		DebugGetDamageTypeString(DamageTypes_t DamageType, char *outbuf, int outbuflength );
...
protected:
	void			Init( CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, const Vector &damageForce, const Vector &damagePosition, const Vector &reportedPosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType );
	...
	int				m_iDamageCustom;
	int				m_iDamageStats;
	AmmoIndex_t				m_iAmmoType;			// AmmoType of the weapon used to cause this damage, if any
...
public:
	...
	void			Init( CSharedBaseEntity *pTarget, CSharedBaseEntity *pInflictor, CSharedBaseEntity *pAttacker, CSharedBaseEntity *pWeapon, const Vector &damageForce, const Vector &damagePosition, const Vector &reportedPosition, float flDamage, DamageTypes_t bitsDamageType, int iKillType );
...
inline void CSharedTakeDamageInfo::SetDamageType( DamageTypes_t bitsDamageType )
{
	m_bitsDamageType = bitsDamageType;
}

inline DamageTypes_t CSharedTakeDamageInfo::GetDamageType() const
{
	return m_bitsDamageType;
}

inline void	CSharedTakeDamageInfo::AddDamageType( DamageTypes_t bitsDamageType )
{
	m_bitsDamageType |= bitsDamageType;
}
...
inline AmmoIndex_t CSharedTakeDamageInfo::GetAmmoType() const
{
	return m_iAmmoType;
}

inline void CSharedTakeDamageInfo::SetAmmoType( AmmoIndex_t iAmmoType )
{
