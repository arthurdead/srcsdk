...
BEGIN_PREDICTION_DATA( C_Team )
	DEFINE_ARRAY_FLAGS( m_szTeamname, FIELD_CHARACTER, MAX_TEAM_NAME_LENGTH, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iScore, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iRoundsWon, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iDeaths, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iPing, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iPacketloss, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_FIELD_FLAGS( m_iTeamNum, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
END_PREDICTION_DATA();
