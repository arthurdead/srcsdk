...
IMPLEMENT_CLIENTCLASS_DT(C_PropVehicleChoreoGeneric, DT_PropVehicleChoreoGeneric, CPropVehicleChoreoGeneric)
	...
	RecvPropBool( RECVINFO_STRUCTELEM( m_vehicleView, bClampEyeAngles ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flPitchCurveZero ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flPitchCurveLinear ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flRollCurveZero ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flRollCurveLinear ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flFOV ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flYawMin ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flYawMax ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flPitchMin ) ),
	RecvPropFloat( RECVINFO_STRUCTELEM( m_vehicleView, flPitchMax ) ),
