...
//	DEFINE_FIELD_FLAGS( m_nOldButtons, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD( m_nOldButtons, FIELD_INTEGER64 ),
...
BEGIN_PREDICTION_DATA( C_BasePlayer )
	...
	DEFINE_FIELD( m_nButtons, FIELD_INTEGER64 ),
	...
	DEFINE_FIELD( m_afButtonLast, FIELD_INTEGER64 ),
	DEFINE_FIELD( m_afButtonPressed, FIELD_INTEGER64 ),
	DEFINE_FIELD( m_afButtonReleased, FIELD_INTEGER64 ),
