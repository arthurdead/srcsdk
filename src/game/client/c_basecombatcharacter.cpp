...
void C_BaseCombatCharacter::DoImpactEffect(trace_t &tr, int nDamageType)
{
	if(GetActiveWeapon())
	{
...
BEGIN_PREDICTION_DATA( C_BaseCombatCharacter )
	...
	DEFINE_ARRAY_FLAGS( m_iAmmo, FIELD_INTEGER,  MAX_AMMO_TYPES, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_flNextAttack, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_FIELD_FLAGS( m_hActiveWeapon, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
	DEFINE_ARRAY_FLAGS( m_hMyWeapons, FIELD_EHANDLE, MAX_WEAPONS, FTYPEDESC_INSENDTABLE ),
