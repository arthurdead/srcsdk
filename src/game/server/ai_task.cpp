...
void CAI_BaseNPC::InitDefaultTaskSR(void)
{
	...
	#define ADD_DEF_TASK_ALIAS( sname, ename ) idSpace.AddTask(#sname, ename, "CAI_BaseNPC" )
...
#else
	ADD_DEF_TASK_ALIAS( TASK_GET_PATH_TO_HINTNODE, TASK_GET_PATH_TO_NAV_AREA );
	ADD_DEF_TASK( TASK_GET_PATH_TO_NAV_AREA );
#endif
...
#else
	ADD_DEF_TASK_ALIAS( TASK_GET_PATH_TO_RANDOM_NODE, TASK_GET_PATH_TO_RANDOM_AREA );
	ADD_DEF_TASK( TASK_GET_PATH_TO_RANDOM_AREA );
#endif
...
#else
	ADD_DEF_TASK_ALIAS( TASK_FACE_HINTNODE, TASK_FACE_NAV_AREA );
	ADD_DEF_TASK( TASK_FACE_NAV_AREA );
	ADD_DEF_TASK_ALIAS( TASK_PLAY_HINT_ACTIVITY, TASK_PLAY_AREA_ACTIVITY );
	ADD_DEF_TASK( TASK_PLAY_AREA_ACTIVITY );
#endif
...
#else
	ADD_DEF_TASK_ALIAS( TASK_FIND_HINTNODE, TASK_FIND_NAV_AREA );
	ADD_DEF_TASK( TASK_FIND_NAV_AREA );
	ADD_DEF_TASK_ALIAS( TASK_CLEAR_HINTNODE, TASK_CLEAR_NAV_AREA );
	ADD_DEF_TASK( TASK_CLEAR_NAV_AREA );
	ADD_DEF_TASK_ALIAS( TASK_FIND_LOCK_HINTNODE, TASK_FIND_LOCK_NAV_AREA );
	ADD_DEF_TASK( TASK_FIND_LOCK_NAV_AREA );
	ADD_DEF_TASK_ALIAS( TASK_LOCK_HINTNODE, TASK_LOCK_NAV_AREA );
	ADD_DEF_TASK( TASK_LOCK_NAV_AREA );
#endif
...
#else
	ADD_DEF_TASK_ALIAS( TASK_FIND_NODE_COVER_FROM_ENEMY, TASK_FIND_AREA_COVER_FROM_ENEMY );
	ADD_DEF_TASK( TASK_FIND_AREA_COVER_FROM_ENEMY );
	ADD_DEF_TASK_ALIAS( TASK_FIND_NEAR_NODE_COVER_FROM_ENEMY, TASK_FIND_NEAR_AREA_COVER_FROM_ENEMY );
	ADD_DEF_TASK( TASK_FIND_NEAR_AREA_COVER_FROM_ENEMY );
	ADD_DEF_TASK_ALIAS( TASK_FIND_FAR_NODE_COVER_FROM_ENEMY, TASK_FIND_FAR_AREA_COVER_FROM_ENEMY );
	ADD_DEF_TASK( TASK_FIND_FAR_AREA_COVER_FROM_ENEMY );
#endif
