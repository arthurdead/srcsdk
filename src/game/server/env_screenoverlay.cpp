...
BEGIN_MAPENTITY( CEnvScreenOverlay )
	...
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 0, FIELD_STRING, "OverlayName1" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 1, FIELD_STRING, "OverlayName2" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 2, FIELD_STRING, "OverlayName3" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 3, FIELD_STRING, "OverlayName4" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 4, FIELD_STRING, "OverlayName5" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 5, FIELD_STRING, "OverlayName6" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 6, FIELD_STRING, "OverlayName7" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 7, FIELD_STRING, "OverlayName8" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 8, FIELD_STRING, "OverlayName9" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_iszOverlayNames, 9, FIELD_STRING, "OverlayName10" ),

	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 0, FIELD_FLOAT, "OverlayTime1" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 1, FIELD_FLOAT, "OverlayTime2" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 2, FIELD_FLOAT, "OverlayTime3" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 3, FIELD_FLOAT, "OverlayTime4" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 4, FIELD_FLOAT, "OverlayTime5" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 5, FIELD_FLOAT, "OverlayTime6" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 6, FIELD_FLOAT, "OverlayTime7" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 7, FIELD_FLOAT, "OverlayTime8" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 8, FIELD_FLOAT, "OverlayTime9" ),
	DEFINE_KEYFIELD_ARRAYELEM( m_flOverlayTimes, 9, FIELD_FLOAT, "OverlayTime10" ),
