...
IMPLEMENT_SERVERCLASS_ST_NOBASE( CTEBaseBeam, DT_BaseBeam )
	...
	SendPropFloat( SENDINFO(m_fLife), 8, SPROP_NONE, 0.0, 25.6 ),
	SendPropFloat( SENDINFO(m_fWidth), 10, SPROP_NONE, 0.0, 128.0 ),
	SendPropFloat( SENDINFO(m_fEndWidth), 10, SPROP_NONE, 0.0, 128.0 ),
	SendPropInt( SENDINFO(m_nFadeLength), 8, SPROP_UNSIGNED ),
	SendPropFloat( SENDINFO(m_fAmplitude), 8, SPROP_NONE, 0.0, 64.0 ),
