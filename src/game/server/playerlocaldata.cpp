...
BEGIN_SEND_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	SendPropFloat	(SENDINFO(m_flDucktime), 12, SPROP_ROUNDDOWN|SPROP_CHANGES_OFTEN, 0.0f, 2048.0f, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	...
	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngle, 0), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngle, 1), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngle, 2), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),

	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngleVel, 0), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngleVel, 1), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	SendPropFloat		( SENDINFO_VECTORELEM(m_vecPunchAngleVel, 2), 32, SPROP_NOSCALE|SPROP_CHANGES_OFTEN, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),

#else
	SendPropFloat	(SENDINFO(m_flFallVelocity), 17, SPROP_CHANGES_OFTEN, -4096.0f, 4096.0f, SendProxy_Float, SENDPROP_CHANGES_OFTEN_PRIORITY ),
	SendPropVector	(SENDINFO(m_vecPunchAngle),      -1,  SPROP_COORD|SPROP_CHANGES_OFTEN, 0.0f, HIGH_DEFAULT, SendProxy_Vector, SENDPROP_CHANGES_OFTEN_PRIORITY),
	...
	SendPropColor32	(SENDINFO_STRUCTELEM(m_skybox3d, skycolor)),
	...
	SendPropColor32( SENDINFO_NESTEDSTRUCTELEM( m_skybox3d, fog, colorPrimary ) ),
	SendPropColor32( SENDINFO_NESTEDSTRUCTELEM( m_skybox3d, fog, colorSecondary ) ),
